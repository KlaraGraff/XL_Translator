...
5. 使用 `packaging/windows/XL_Translator_Windows.spec` 构建 one-folder 可执行包
6. 压缩 `dist/XL_Translator_Windows`

最终用户下载 zip 后，完整解压并双击 `XL Translator.exe` 即可启动。
