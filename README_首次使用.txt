【macOS 用户怎么做】
1) 如果下载的是 GitHub Release 里的 macOS 安装包，请先打开“Translator_macOS_6.1.dmg”或后续更高版本 dmg。
...
【Windows 用户怎么做】
1) 如果下载的是 GitHub Release 里的 Windows 安装包，请直接运行“Translator_Windows_6.1_Setup.exe”或后续更高版本安装包。
